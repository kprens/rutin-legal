...
## Temel ilke: verileriniz cihazınızda

Rutin, alışkanlık verilerinizi (streak sayaçları, günlük görevler, su takibi, takvim kayıtları, istatistikler) **yalnızca kendi cihazınızda** saklar. Bu veriler, siz açıkça paylaşmayı seçmedikçe hiçbir sunucuya gönderilmez.
...
Uygulamanın ücretsiz sürümünde Google AdMob aracılığıyla reklam gösterilir. AdMob, reklam sunumu için cihaz tanımlayıcıları gibi veriler işleyebilir; ayrıntılar için [Google'ın gizlilik politikasına](https://policies.google.com/privacy) bakınız. Rutin Pro aboneliği reklamları tamamen kaldırır.

## Çökme raporları

Uygulama kararlılığını iyileştirmek için anonim çökme raporları (cihaz modeli, işletim sistemi sürümü, hata ayrıntısı) toplanabilir (Sentry). Bu raporlar alışkanlık verilerinizi içermez.
...
Bu politika güncellenirse, güncel sürüm bu sayfada yayınlanır.

## İletişim

Sorularınız için: alperen8taskiran@gmail.com
...
Rutin stores your habit data (streak counters, daily tasks, water tracking, calendar entries, statistics) **only on your device**. This data is never sent to any server unless you explicitly choose to share it.
...
The free version shows ads via Google AdMob, which may process device identifiers to serve ads. See [Google's privacy policy](https://policies.google.com/privacy). Rutin Pro removes all ads.

## Crash reports

Anonymous crash reports (device model, OS version, error details) may be collected via Sentry to improve stability. They never include your habit data.
...
Questions: alperen8taskiran@gmail.com
